...
#tmux new-session -d -s e2v_train 'bash /workspace/finetrainers/examples/training/control/wan/reference_condition/train_lora_base.sh > /workspace/e2v_log.txt 2>&1' 

#git fetch && git stash && git pull && tmux new-session -d -s e2v_train 'bash /workspace/finetrainers/examples/training/control/wan/reference_condition/train_lora_base.sh > /workspace/e2v_log.txt 2>&1'  
